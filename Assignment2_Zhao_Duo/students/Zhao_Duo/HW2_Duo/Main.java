 ...
 */
public class Main {
    // GRADING: Making everything static is essentially writing a normal
    // procedural program - not really object-oriented.
	...
	public static void main(String[] args) {
		try {
            ...
            // GRADING: Some of these lines are really long.  For good style,
            // try to stay under 80 characters or so
	...
	public static int scanToken(BufferedReader source) {
		try{
			 ...
			 */
            // GRADING: Should have a single outer loop, with the switch
            // statement considering cases.
			switch(currentChar){
			case '(':
